    ...
    <main>
      <header className="row tm-welcome-section">
        ...
        <p className="col-12 text-center">
          This is about page of simple house template. You can modify and use this HTML template for
          your website. Total 3 HTML pages included in this template. Header image has a parallax
          effect.
        </p>
      </header>
        ...
        <div className="row">
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src="../../src/assets/img/about-01.jpg" alt="Image" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
                ...
                <p className="tm-person-about">
                  Vivamus cursus leo nec sem feugiat sagittis. Duis ut feugiat odio, sit amet
                  accumsan odio.
                </p>
                <div>
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src="../../src/assets/img/about-02.jpg" alt="Image" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
                <h4 className="tm-person-name">Daisy Walker</h4>
                <p className="tm-person-title">Executive Chef</p>
                <p className="tm-person-about">
                  Praesent non vulputate elit. Orci varius natoque et magnis dis parturient,
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src="../../src/assets/img/about-03.jpg" alt="Image" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
                <h4 className="tm-person-name">Florence Nelson</h4>
                <p className="tm-person-title">Kitchen Manager</p>
                <p className="tm-person-about">
                  Aenean sapien sem, ultricies sed vulputate et, auctor vel mauris. Integer sit amet
                  diam eget est facilisis lacinia vitae.
                </p>
                <div>
                  <a href="https://fb.com" className="tm-social-link">
                    <i className="fab fa-facebook tm-social-icon"></i>
          ...
          <article className="col-lg-6">
            <figure className="tm-person">
              <img src="../../src/assets/img/about-04.jpg" alt="Image" className="img-fluid tm-person-img" />
              <figcaption className="tm-person-description">
                <h4 className="tm-person-name">Valentina Martin</h4>
                <p className="tm-person-title">Culinary Director</p>
                <p className="tm-person-about">
                  Praesent non vulputate elit. Orci varius natoque penatibus et magnis montes,
                  nascetur ridiculus mus.
                </p>
                <div>
                  <a href="https://fb.com" className="tm-social-link">
                  ...
                  <a href="https://youtube.com" className="tm-social-link">
                    <i className="fab fa-youtube tm-social-icon"></i>
                  </a>
                </div>
              </figcaption>
            </figure>
          ...
          <div className="col-12">
            <div className="placeholder-2">
              <div
                ...
                data-image-src="../../src/assets/img/about-05.jpg"></div>
            </div>
          </div>
        </div>
      </div> */}
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="tm-feature">
              ...
              <p className="tm-feature-description">
                ...
                porttitor arcu a, interdum est. Donec in risus eu ante.
              </p>
          ...
          <div className="col-lg-4">
            <div className="tm-feature">
              ...
              <p className="tm-feature-description">
                Maecenas pretium rutrum molestie. Duis dignissim egestas turpis sit. Nam sed
                suscipit odio. Morbi in dolor finibus, consequat nisl eget.
              </p>
          ...
          <div className="col-lg-4">
            <div className="tm-feature">
              ...
              <p className="tm-feature-description">
                Morbi in dolor finibus, consequat nisl eget, pretium nunc. Maecenas pretium rutrum
                molestie. Duis dignissim egestas turpis sit.
              </p>
            ...
            <div className="tm-history-inner">
              ...
              <div className="tm-history-text">
                ...
                <p className="tm-mb-p">
                  ...
                  Maecenas posuere lorem id augue interdum vehicula. Praesent sed leo eget libero
                  ultricies congue.
                </p>
                <p>
